<?php
class CRM_Event_Badge_Logo5395_Letter extends CRM_Event_Badge {
  function __construct() {
    ...
    $w = 85.852;
    $this->format = array(
      'name' => 'Avery 5395', 'paper-size' => 'Letter', 'metric' => 'mm', 'lMargin' => -11,
      'tMargin' => -10, 'NX' => 2, 'NY' => 4, 'SpaceX' => 13, 'SpaceY' => 7,
